...
go
-- Xoá produce
drop proc sp_HIENTHI_MONHOC
drop PROC sp_THEM_MONHOC
drop PROC sp_SUA_MONHOC
drop PROC sp_XOA_MONHOC
drop PROC sp_DEM_MONHOC
go
...
CREATE TABLE DIEM(
	...
	MaSV VARCHAR(7) REFERENCES SINH_VIEN(MaSV),
	MaMH VARCHAR(7) REFERENCES MON_HOC(MaMH),
	DiemThi FLOAT(2)
)
GO
INSERT INTO MON_HOC VALUES
('COM1024',N'Tin học văn phòng',2),
('COM2012',N'Cơ sở dữ liệu',3),
('MOB1013',N'Lập trình Java 1',3);          
GO
INSERT INTO SINH_VIEN VALUES
('PS02942',N'Lê Thảo',N'Nguyên','2000-08-15'),
...
--2. Viết store proc tên là sp_HIENTHI_MONHOC : Xuất thông tin của tất cả các môn học.
if OBJECT_ID ('sp_HIENTHI_MONHOC') is not null
drop proc sp_HIENTHI_MONHOC
go
create proc sp_HIENTHI_MONHOC
as
begin
	select * from MON_HOC
end
go
-- thi hành
exec sp_HIENTHI_MONHOC


--3. Viết store proc tên là sp_THEM_MONHOC : THÊM MÔN HỌC
if OBJECT_ID ('sp_THEM_MONHOC') is not null
drop proc sp_THEM_MONHOC
go
CREATE PROC sp_THEM_MONHOC
	@MaMH varchar(7),
	@TenMH nvarchar(50),
	@SoTC int
AS
BEGIN
	INSERT INTO MON_HOC VALUES (@MaMH,@TenMH,@SoTC);
END
go
-- thi hành
EXEC sp_THEM_MONHOC 'SOF203',N'Java3',2
--
SELECT * from MON_HOC


--4. Viết store proc tên là sp_SUA_MONHOC : SỬA MÔN HỌC
if OBJECT_ID ('sp_SUA_MONHOC') is not null
drop proc sp_SUA_MONHOC
go
CREATE PROC sp_SUA_MONHOC
	@MaMH VARCHAR(7),
	@TenMH NVARCHAR(50),
	@SoTC int
AS
...
go
--Thực thi
exec sp_SUA_MONHOC 'SOF203', N'Java 3', 3
go
--Truy vấn lại bảng
SELECT * FROM MON_HOC


--5. Viết store proc tên là sp_XOA_MONHOC : XÓA MÔN HỌC
if OBJECT_ID ('sp_XOA_MONHOC') is not null
drop proc sp_XOA_MONHOC
go
CREATE PROC sp_XOA_MONHOC
	@MaMH varchar(10)
AS
BEGIN
	DELETE FROM MON_HOC
...
go
--Thực thi
exec sp_XOA_MONHOC 'SOF203'
go
--Truy vấn lại bảng
SELECT * FROM MON_HOC


--6. Viết store proc tên là sp_DEM_MONHOC : ĐẾM SỐ CÁC MÔN HỌC
if OBJECT_ID ('sp_DEM_MONHOC') is not null
drop proc sp_DEM_MONHOC
go
CREATE PROC sp_DEM_MONHOC
AS
BEGIN
	SELECT COUNT(MaMH) as N'Số lượng môn học' FROM MON_HOC
END
go
--Chay thu
exec sp_DEM_MONHOC
...
(N'Nguyễn Hoàng Duy','1','0919993715',N'140 Huỳnh Văn Bánh, Phường 12',N'Phú Nhuận','duy@gmail.com'),
(N'Nguyễn Hoàng Dũng','1','0123456789',N'370 Lê Văn Lương, Tân Hưng',N'Quận 7','dung@gmail.com'),
(N'Đinh Tiến Đạt','1','0164846138',N'113 Cộng Hoà, Phường 12',N'Tân Bình','dat@gmail.com'),
(N'Hồ Hoài Hương','0','0894153484',N'150 Trường Chinh, Phường 12',N'Tân Bình','huong@gmail.com'),
(N'Thạch Nhật Tiến','1','0345451245',N'233 Đinh Bộ Lĩnh, Phường 26',N'Bình Thạnh','tien@gmail.com'),
(N'Trần Nam Kiệt','1','0324444517',N'379 Huỳnh Tấn Phát, Tân Thuận Đông',N'Quận 7','kiet@gmail.com'),
(N'Ngyễn Thị Thu','0','0789114256',N'29 Nguyễn Trung Ngạn, Bến Nghé',N'Quận 1','thu@gmail.com'),
(N'Ngô Minh Kiên','1','0412454359',N'496 Nguyễn Đình Chiểu, Phường 4',N'Quận 3','kien@gmail.com'),
(N'Võ Thuỳ Oanh','0','0178811561',N'124 Nam Kỳ Khởi Nghĩa, Bến Thành',N'Quận 1','oanh@gmail.com'),
(N'Trần Thu Hiền','0','0365841258',N'01 Lương Định Của, An phú',N'Quận 2','hien@gmail.com'),
(N'Nguyễn Văn Đức','1','0685596317',N'139 Dương Bá Trạc, Phường 1',N'Quận 8','duc@gmail.com'),
(N'Lê Văn Hưng','1','0853127141',N'191 Quang Trung, Hiệp Phú',N'Quận 9','hung@gmail.com'),
(N'Nguyễn Thị Nhung','0','0252347855',N'61 đường 5, KP2, Cát Lái',N'Quận 2','nhung@gmail.com'),
(N'Trần Ngọc Anh','1','0354124778',N'85 Trần Đình Xu, Nguyễn Cư Trinh,',N'Quận 1','anh@gmail.com'),
(N'Lê Thuý Kiều','0','0235878912',N'968 Quốc lộ 1A, Linh Trung',N'Thủ Đức','kieu@gmail.com')
GO
...
go
--Thực thi
exec sp_NguoiDung_insert N'Nguyễn Hoàng Duy',0,'0919993715',N'Huỳnh Văn Bánh, Phường 12',N'Quận Phú Nhuận','duyngps18293@fpt.edu.vn'
go
...
AS
BEGIN
	INSERT INTO NHATRO VALUES(@MaNhaTro,@MaLoaiNha,@DienTich,@GiaPhong,@Quan,@MoTa,@NgayDang)
END
go
-- thi hành
EXEC sp_NhaTro_insert 16,4,50.6,5000000,N'Quận 12',N'Cho Thuê','11-22-2020'
go
SELECT * FROM NHATRO
go
